...
are explanatory, not isolated MMA throughput. The QK ceilings are `419 TFLOP/s` for E4M3/FP32 and
`838 TFLOP/s` for E2M1/UE4M3/FP32; PV uses the `209.5 TFLOP/s` FP16/FP32 ceiling in both modes.
